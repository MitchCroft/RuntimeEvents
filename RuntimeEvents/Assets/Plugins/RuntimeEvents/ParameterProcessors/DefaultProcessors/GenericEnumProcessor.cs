...
namespace RuntimeEvents.ParameterProcessors {
    ...
    /// </summary>
    [CustomTypeProcessor(typeof(Enum))]
    public sealed class GenericEnumProcessor : AParameterProcessor {
        /*----------Functions----------*/
        //PUBLIC
        ...
        /// <remarks>Generic enum has inconsistent type values being passed through. Invalid value objects will reset cache information</remarks>
        public override bool AssignValue(PersistentParameterCache parameterCache, object value) {
            ...
            } else parameterCache.ResetValues();
            return true;
        }
    }
}