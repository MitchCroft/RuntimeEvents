...
namespace RuntimeEvents.ParameterProcessors {
    /// <summary>
    /// Provide the functionality required to display boolean toggle options within the Runtime Event inspector
    /// </summary>
    [CustomParameterDrawer(typeof(bool))]
    public sealed class BoolDrawer : AParameterDrawer {
        /*----------Functions----------*/
        //PUBLIC

        /// <summary>
        /// Bool drawing is a simple process, only requires a single line
        /// </summary>
        ...
        /// <summary>
        /// Display the current boolean value setting to the inspector
        /// </summary>
        ...
        public override bool DisplayParameterValue(Rect position, PersistentParameterCache[] parameterCaches, GUIContent label) {
            ...
            using (GUIMixer.PushSegment(isDifferent)) {
                ...
                bool newState = EditorGUI.Toggle(position, label, state);
