...
namespace RuntimeEvents.ParameterProcessors {
    /// <summary>
    /// Provide the functionality required to display Vector4 options within the Runtime Event inspector
    /// </summary>
    [CustomParameterDrawer(typeof(Vector4))]
    public sealed class Vector4Drawer : AParameterDrawer {
        /*----------Functions----------*/
        //PUBLIC

        /// <summary>
        /// Vector4 drawing is a simple process, only requires a single line
        /// </summary>
