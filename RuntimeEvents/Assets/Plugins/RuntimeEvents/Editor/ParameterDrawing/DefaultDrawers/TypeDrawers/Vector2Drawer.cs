...
namespace RuntimeEvents.ParameterProcessors {
    /// <summary>
    /// Provide the functionality required to display Vector2 options within the Runtime Event inspector
    /// </summary>
    [CustomParameterDrawer(typeof(Vector2))]
    public sealed class Vector2Drawer : AParameterDrawer {
        /*----------Functions----------*/
        //PUBLIC

        /// <summary>
        /// Vector2 drawing is a simple process, only requires a single line
        /// </summary>
        ...
        /// <summary>
        /// Display the current Vector2 value setting to the inspector
        /// </summary>
        ...
        public override bool DisplayParameterValue(Rect position, PersistentParameterCache[] parameterCaches, GUIContent label) {
            ...
            Vector2 vector = (Vector2)parameterCaches[0].Value;
            ...
            using (GUIMixer.PushSegment(isDifferent)) {
                ...
                Vector2 newVector = EditorGUI.Vector2Field(position, label, vector);
